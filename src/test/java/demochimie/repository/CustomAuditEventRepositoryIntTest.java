...
import demochimie.config.audit.AuditEventConverter;
import demochimie.domain.PersistentAuditEvent;
...
import static demochimie.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
